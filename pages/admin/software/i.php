...
<div class="border mb-5" v-if="visible" id="admin-software">
  ...
  <form class='w-50 m-auto' method='POST' enctype="multipart/form-data" ref="img_form" id="software-form">
    ...
    <div class="w-100 m-auto">
      ...
      <button type="button" class="btn btn-primary" v-if="loading"><span class="spinner-border spinner-border-sm"></span> <span> Uploading... {{percentage}}%</span></button>
        ...
        upload() {
            ...
            axios({
                ...
                onUploadProgress: function(uploadEvent) {
                    $this.percentage = parseInt( (uploadEvent.loaded / uploadEvent.total) * 100)
                    
                    console.log(uploadEvent, 'my upload event')
                }
            })
            .then(res => {
              if(res.data == "SUCCESS") {
                this.alertmsg("Uploaded Successfullyl", "success")
              }
                this.loading = false
            })          
            }
