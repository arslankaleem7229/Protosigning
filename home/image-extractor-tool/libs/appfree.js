...
function drawInlineSVG(I1, h1) {
    ...
    b1["src"] = d1;    
    logo_vue.loaded(h1)
    console.log(b1, 'inline svg')
    $("#download-btn")["css"]("display", "block");
    $("#edit-btn")["css"]("display", "block");
    $("#loadingMsg")["css"]("display", "none");
    alertmsg("Image Converted Successfully", "success")
    $("#svg-cut-wrapper").removeClass("d-none")
}
...
function drawInlineSplitSVG(q1, N1) {
    ...
    console.log(r1, B1, $("#splitSVGcanvas")[0], 'drawInlineSplitSVG')
}
